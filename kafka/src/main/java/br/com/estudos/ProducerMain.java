...
public class ProducerMain {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        LOG.info("Executing send producer....");
        ...
        ProducerRecord<String, String> precordEmail = new ProducerRecord<>("ECOMMERCE_SEND_EMAIL", key, email);

        producer.send(record, callback).get();
        producer.send(precordEmail, callback).get();
